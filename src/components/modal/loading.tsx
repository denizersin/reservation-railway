...
export const DialogDemo = forwardRef<DialogRef, {}>((props, ref) => {
    ...
    return (
        <div className={cn('w-screen h-screen fixed z-[9999] bg-black/40 flex justify-center left-0 top-0 items-center', {
            '!hidden': !isOpen
        })}>
            <div role="status">
...
export let LoadingModal: DialogRef = {} as DialogRef

const LoadingModalWrapper: React.FC = () => {
